...
public class PnlDatVe extends JPanel {
    ...
    private static final Color COLOR_HELD = new Color(33, 150, 243);          // Material Blue 500
    ...
    private static final Color COLOR_HELD_BORDER = new Color(21, 101, 192);        // Darker blue
    ...
    private void hienThiSoDoGhe(String maToa) {
        ...
        if (danhSachGhe.isEmpty()) {
            ...
            pnlSoDoGhe.setLayout(new GridLayout(soHang, 5, 8, 8)); // Increased spacing for modern look
    ...
    private JButton taoNutGhe(Ghe ghe) {
        ...
        // Check if held first (highest priority for display)
